            ...
            if true {
                ZStack {
                    ...
                    GoogleAdBannerView(bannerView: bannerView)
                        ...
                        .overlay {
                            RoundedRectangle(cornerRadius: 5).stroke(Color.textColorStrong, lineWidth: 4)
                        }
                        .cornerRadius(5)
                    VStack {
                        Spacer()
                        HStack {
                            ...
                            MultiColorAnimeTextView(texts: [Text("Ad")],
                                                    fonts: [.system(size: 7)],
                                                    forgroundColors: [.textColorNormal],
                                                    backgroundColors: [.red,.orange,.yellow,.green,.blue,.purple,.red],
                                                    fps: 60 )
                            .padding(.leading, -bannerSize.width / 2 - 10)
                            Spacer()
                        }
                        .padding(.top, -bannerSize.height / 2 - 10)
                        Spacer()
                    }
